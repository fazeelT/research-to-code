"""
Implementation of: Geometry-aware similarity metrics for neural representations on Riemannian and statistical manifolds
Source: arxiv - http://arxiv.org/abs/2603.28764v1
...
class GeometryawareSimilarityMetricsForNeuralRepresentationsOnRiemannianAndStatisticalManifolds(nn.Module):
    """
...
if __name__ == '__main__':
    print("Testing GeometryawareSimilarityMetricsForNeuralRepresentationsOnRiemannianAndStatisticalManifolds...")
    model = GeometryawareSimilarityMetricsForNeuralRepresentationsOnRiemannianAndStatisticalManifolds()
    model.eval()
