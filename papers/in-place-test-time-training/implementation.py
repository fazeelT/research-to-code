"""
Implementation of: In-Place Test-Time Training
Source: arxiv - http://arxiv.org/abs/2604.06169v1
...
class InPlaceTestTimeTraining(nn.Module):
    """
...
class InPlaceTestTimeTrainingCUDA(InPlaceTestTimeTraining):
    """
...
if __name__ == '__main__':
    print("Testing InPlaceTestTimeTraining...")
    
    # CPU test
    model_cpu = InPlaceTestTimeTraining()
    ...
    if torch.cuda.is_available():
        model_cuda = InPlaceTestTimeTrainingCUDA()
        x_cuda = x.cuda()
