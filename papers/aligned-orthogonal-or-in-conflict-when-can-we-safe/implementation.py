"""
Implementation of: Aligned, Orthogonal or In-conflict: When can we safely optimize Chain-of-Thought?
Source: arxiv - http://arxiv.org/abs/2603.30036v1
...
class AlignedOrthogonalOrInconflictWhenCanWeSafelyOptimizeChainofThought(nn.Module):
    """
...
class AlignedOrthogonalOrInconflictWhenCanWeSafelyOptimizeChainofThoughtCUDA(AlignedOrthogonalOrInconflictWhenCanWeSafelyOptimizeChainofThought):
    """
...
if __name__ == '__main__':
    print("Testing AlignedOrthogonalOrInconflictWhenCanWeSafelyOptimizeChainofThought...")
    
    # CPU test
    model_cpu = AlignedOrthogonalOrInconflictWhenCanWeSafelyOptimizeChainofThought()
    ...
    if torch.cuda.is_available():
        model_cuda = AlignedOrthogonalOrInconflictWhenCanWeSafelyOptimizeChainofThoughtCUDA()
        x_cuda = x.cuda()
